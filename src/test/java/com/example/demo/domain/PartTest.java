...
class PartTest {
    ...
    // Unit test to ensure getters and setters for min and max inventory work as expected
    @Test
    void testMinInventory() {
        int minVal = 5;
        partIn.setMinInventory(minVal);
        assertEquals(minVal,partIn.getMinInventory());
        partOut.setMinInventory(minVal);
        assertEquals(minVal,partOut.getMinInventory());
    }

    @Test
    void testMaxInventory() {
        int maxVal = 50;
        partIn.setMaxInventory(maxVal);
        assertEquals(maxVal,partIn.getMaxInventory());
        partOut.setMaxInventory(maxVal);
        assertEquals(maxVal,partOut.getMaxInventory());
    }
}